...
export default class SelectHardware extends Component {
  ...
  renderQRHardwareWalletSteps() {
    ...
    steps.push({
      ...
      message: 'These QR code-compatible hardware wallets have air-gap level of security to protect your private keys.',
    });

    steps.push({
      message: 'Click on the concerning link below for more information:',
    });
    ...
    steps.push({
      ...
      dimensions: { width: '225px', height: '75px' },
      message: 'More wallet integrations are currently being prepared and will become available.',
    });
